...
CATEGORY_DESCRIPTIONS = [
    CategoryDescription(
        ...
        description=(
            ...
            "BI 商業智慧工具、自然語言報表產生、AI 影像與影片產製、"
            "資料科學平台、預測分析、決策支援系統、演算法運算。"
            "常見案例：AI 運算協作管理平台、智慧教學系統、大數據分析工具、"
            "資料分析平台、商業智慧系統、機器學習平台、智慧教室、校務分析儀表板、"
            "AI 教學助理、AI 備課出題批改、AI 賦能計畫相關系統。"
        ),
        keywords=["AI", "人工智慧", "機器學習", "大數據", "資料分析", "智慧", "報表", "影像產製", "預測", "演算法"],
    ),
    CategoryDescription(
        name="系統開發/平台建置",
        description=(
            ...
            "雲端平台導入、服務平台開發、系統升級專案、流程自動化。"
            "常見案例：管理系統開發建置、協作平台建置、資訊系統整合、"
            "應用系統開發、平台導入專案、系統客製化開發、校務行政整合平台、"
            "教務學務總務系統、數位學習平台 LMS、教學平台、RPA 自動化、文件流轉平台。"
        ),
        keywords=["系統", "平台", "建置", "開發", "整合", "協作", "校務", "LMS", "RPA", "管理系統"],
    ),
    CategoryDescription(
        name="資安/網路安全",
        description=(
            ...
            "資通安全設備、Email Security、DLP 防資料外洩、防釣魚、端點防護、"
            "加密系統、身份認證系統。"
            "常見案例：網頁應用程式防火牆授權、防火牆設備採購、資安弱點掃描、"
            "防毒軟體訂閱、零信任架構建置、IDS/IPS 系統、Fortinet、Palo Alto、"
            "SentinelOne、CrowdStrike、資安監控平台。"
        ),
        keywords=["資安", "防火牆", "WAF", "弱點", "防毒", "零信任", "Email Security", "DLP", "防釣魚", "IDS", "IPS", "資通安全"],
    ),
    CategoryDescription(
        name="網路/通訊設備",
        description=(
            ...
            "校園 WiFi 建置、Aruba、Cisco Meraki、Ruckus、路由器設備、"
            "光纖網路建置、無線網路擴充。"
        ),
        keywords=["網路", "基地台", "AP", "交換器", "路由器", "WiFi", "無線", "Aruba", "Meraki", "Ruckus", "網通"],
    ),
    CategoryDescription(
        name="文件/檔案管理系統",
        description=(
            ...
            "RAG 知識庫問答、OCR 文件辨識、AI 分類摘要、內容管理系統（CMS）、"
            "文檔協作平台、公文流程系統。"
            "常見案例：檔案管理系統開發建置、電子公文系統、文件管理平台、"
            "知識管理系統、企業文件問答、發票合約公文結構化、文檔加密系統、"
            "文書處理系統、公文系統、文件流轉、校務文件管理。"
        ),
        keywords=["檔案", "文件", "OCR", "RAG", "知識庫", "管理系統", "知識管理", "電子公文", "文管", "文書"],
    ),
    CategoryDescription(
        name="硬體設備",
        description=(
            "一般資訊硬體設備採購，包含個人電腦、筆記型電腦、伺服器、"
            "工作站、Thin Client、零終端、繪圖板、繪圖機、辦公資訊設備。"
            "不包含：醫療設備（節律器、呼吸器、超音波乳化儀等）、"
            "實驗室量測儀器（示波器、電錶、函數產生器、質譜儀、顯微鏡等）。"
            "常見案例：筆記型電腦採購、桌上型電腦、伺服器設備、"
            "工作站採購、虛擬桌面設備、Wacom 繪圖板、HP DesignJet 繪圖機、資訊設備汰換。"
        ),
        keywords=["筆記型電腦", "電腦", "伺服器", "PC", "工作站", "Thin Client", "繪圖板", "繪圖機", "資訊設備"],
    ),
    CategoryDescription(
        name="軟體/授權訂閱",
        description=(
            ...
            "Microsoft 365、Azure、Windows Server、CAL、校園授權 EES、企業 EA、"
            "Acrobat、Substance、應用軟體訂閱、軟體維護更新、軟體升級授權。"
            "常見案例：軟體授權採購、Office 365 訂閱、Adobe Creative Cloud 授權、"
            "防毒軟體授權、作業系統升級、Microsoft 校園授權、應用程式授權、軟體維護服務。"
        ),
        keywords=["軟體", "授權", "訂閱", "Microsoft 365", "Azure", "EES", "Office", "Adobe", "Acrobat"],
    ),
    CategoryDescription(
        name="雲端/虛擬化",
        description=(
            ...
            "虛擬化平台、VM 管理、VMware、Hyper-V、Citrix、虛擬桌面、"
            "容器平台（Docker/Kubernetes）。"
            "常見案例：雲端平台服務、虛擬化環境建置、容器平台導入、"
            "雲端服務訂閱、機房整併、實體伺服器汰換、私有雲建置、雲端儲存服務。"
        ),
        keywords=["雲端", "Cloud", "虛擬化", "VMware", "Hyper-V", "Citrix", "VM", "容器", "SaaS", "IaaS", "PaaS"],
    ),
    CategoryDescription(
        name="儲存/備份/資料庫",
        description=(
            ...
            "SQL 服務器、資料備份方案、備份備援、儲存擴充。"
            "常見案例：NAS 儲存設備、備份系統建置、磁碟陣列採購、"
            "NetApp、Pure Storage、QNAP、Veeam、Acronis、Commvault、"
            "資料庫授權、SQL Server、備份軟體、儲存設備汰換。"
        ),
        keywords=["儲存", "備份", "Veeam", "Acronis", "Commvault", "NetApp", "QNAP", "NAS", "SAN", "磁碟陣列", "資料庫", "Database"],
    ),
    CategoryDescription(
        name="機房/基礎設施",
        description=(
