...
CATEGORY_DESCRIPTIONS = [
    CategoryDescription(
        ...
        description=(
            ...
            "BI 商業智慧工具、資料科學平台、預測分析、決策支援系統。"
            "常見案例：AI 運算協作管理平台、智慧教學系統、大數據分析工具、"
            "資料分析平台、商業智慧系統、機器學習平台、智慧教室、校務分析儀表板。"
        ),
        keywords=["AI", "人工智慧", "機器學習", "大數據", "資料分析", "智慧", "預測"],
    ),
    CategoryDescription(
        name="系統開發/平台建置",
        description=(
    ...
    CategoryDescription(
        ...
        description=(
            ...
            "工作站、印表機、掃描器、投影機、螢幕等辦公資訊設備。"
            "常見案例：筆記型電腦採購、桌上型電腦、伺服器設備、"
            "工作站採購、印表機設備、投影設備、資訊設備汰換。"
        ),
        keywords=["筆記型電腦", "電腦", "伺服器", "PC", "工作站", "印表機", "資訊設備"],
    ),
    CategoryDescription(
        name="軟體/授權訂閱",
        description=(
            "軟體授權採購、訂閱服務、應用程式授權。"
            "包含作業系統授權、Office 軟體、防毒軟體、應用軟體訂閱、"
            "軟體維護更新、軟體升級授權。"
            "常見案例：軟體授權採購、Office 訂閱、防毒軟體授權、"
            "作業系統升級、應用程式授權、軟體維護服務。"
        ),
        keywords=["軟體", "授權", "訂閱", "應用程式", "Office", "防毒軟體"],
    ),
    CategoryDescription(
        name="雲端/虛擬化",
        description=(
    ...
    CategoryDescription(
        ...
        keywords=["機房", "機櫃", "UPS", "電力", "空調", "不斷電系統"],
    ),
]
